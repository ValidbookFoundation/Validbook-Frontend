    ...
    return (
      <html lang="en-US">
        <head>
          ...
          <link id="favicon" rel="shortcut icon" href="/Validson_Favicon_light.ico" />
          <meta name="description" content="Validbook – a universal platform for cooperation." />
          <link rel="manifest" href="/manifest.json" />
          <link rel="stylesheet" href="https://fonts.googleapis.com/icon?family=Material+Icons|Roboto:400,500,700"/>
          <script src="https://cdnjs.cloudflare.com/ajax/libs/ace/1.2.9/ace.js"></script>
          <script src="/graph/shingle.js" type="text/javascript"></script> 
          <script src="/graph/shingleInfoPanel.js" type="text/javascript"></script>
